class UIModOptionsMenu_TestOptionsScreen extends UIScreen;
...
simulated function InitScreen(XComPlayerController InitController, UIMovie InitMovie, optional name InitName)
{
	...
	TitleHeader.InitPanelHeader('', "Test Mod Options", "");
	...
	`LOG("Mod Options Menu: Test Mod options screen initialized.");
}
...
simulated function OnInit()
{
	...
	`LOG("Mod Options Menu: Test Mod options screen shown.");
}
