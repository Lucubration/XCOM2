class DisableAnyClassWotc_Config extends Object
	config(DisableAnyClassWotc);

var config array<name>						ClassNames;

var() DisableAnyClassWotc_ClassValuesCollection	ClassValues;

static function InitClassValues()
{
	local X2SoldierClassTemplateManager		ClassTemplateManager;
	local X2SoldierClassTemplate			ClassTemplate;
	local DisableAnyClassWotc_ClassValues	ClassValue;
	local int								i;
...
DefaultProperties
{
	Begin Object Class=DisableAnyClassWotc_ClassValuesCollection Name=DefaultClassValues
	End Object
