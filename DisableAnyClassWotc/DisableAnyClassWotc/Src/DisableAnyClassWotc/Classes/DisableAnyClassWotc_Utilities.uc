class DisableAnyClassWotc_Utilities extends Object;
...
static function CheckXComHQSoldierClassDeck()
{
	...
	{
		if (class'DisableAnyClassWotc_Config'.static.IsDisabledClass(ClassName))
		{
	...
	`LOG("Disable Any Class: Trimmed Xcom HQ class deck.");
...
static function CheckResistanceHQSoldierClassDeck()
{
	...
	`LOG("Disable Any Class: Trimmed Resistance HQ class deck.");
...
static function TrimXComHQSoldierClassDeck(XComGameState_HeadquartersXCom XComHQ)
{
	...
	DisabledClassNames = class'DisableAnyClassWotc_Config'.default.ClassNames;
...
static function TrimResistanceHQSoldierClassDeck(XComGameState_HeadquartersResistance ResistanceHQ)
{
	...
	for (i = ResistanceHQ.SoldierClassDeck.Length - 1; i >= 0; i--)
	{
		...
		if (DisabledClassNames.Find(ClassName) != INDEX_NONE)
		{
			...
			`LOG("Disable Any Class: Trimmed disabled class " @ ClassName @ " from Resistance HQ deck.");
		}
	}
}
