...
//BEGIN AUTOGENERATED CODE: Template Overrides 'ChryssalidBurrow'
	Template.bFrameEvenWhenUnitIsHidden = true;
//END AUTOGENERATED CODE: Template Overrides 'ChryssalidBurrow'
	
	return Template;
}

simulated function Burrow_BuildVisualization(XComGameState VisualizeGameState)
{
	...
	class'X2Action_Burrow'.static.AddToVisualizationTree(ActionMetadata, Context, false, ActionMetadata.LastActionAdded);
...
simulated function Burrow_BuildVisualizationSync( name EffectName, XComGameState VisualizeGameState, out VisualizationActionMetadata ActionMetadata )
{
	local XComGameStateContext_Ability  Context;
	local X2AbilityTemplate AbilityTemplate;
	local int EffectIndex;
	...
	class'X2Action_Burrow'.static.AddToVisualizationTree( ActionMetadata, Context );
...
//BEGIN AUTOGENERATED CODE: Template Overrides 'ChryssalidUnburrow'
	Template.bFrameEvenWhenUnitIsHidden = true;
//END AUTOGENERATED CODE: Template Overrides 'ChryssalidUnburrow'
...
simulated function Unburrow_BuildVisualization(XComGameState VisualizeGameState)
{
	local XComGameStateHistory History;
	local XComGameStateContext_Ability  Context;
	local StateObjectReference InteractingUnitRef;
	...
	{
		ActionMetadata.VisualizeActor = History.GetVisualizer(EnemyUnitsThatSeeThisUnit[0].ObjectID);
		ActionMetadata.StateObject_OldState = History.GetGameStateForObjectID(EnemyUnitsThatSeeThisUnit[0].ObjectID, eReturnType_Reference, VisualizeGameState.HistoryIndex - 1);
...
static function X2AbilityTemplate CreateBurrowedAttackAbility()
{
	...
	Template.BuildNewGameStateFn = TypicalAbility_BuildGameState;
//BEGIN AUTOGENERATED CODE: Template Overrides 'BurrowedAttack'
	Template.bFrameEvenWhenUnitIsHidden = true;
//END AUTOGENERATED CODE: Template Overrides 'BurrowedAttack'
...
static function X2AbilityTemplate CreateUnburrowSawEnemyAbility()
{
	...
	Template.BuildNewGameStateFn = TypicalAbility_BuildGameState;
//BEGIN AUTOGENERATED CODE: Template Overrides 'UnburrowSawEnemy'
	Template.bFrameEvenWhenUnitIsHidden = true;
//END AUTOGENERATED CODE: Template Overrides 'UnburrowSawEnemy'
