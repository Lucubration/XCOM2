...
var config array<name> SECTOID_REANIMATION_EXCLUDE_UNIT_TYPES;
...
//BEGIN AUTOGENERATED CODE: Template Overrides 'DelayedPsiExplosion'
	Template.bFrameEvenWhenUnitIsHidden = true;
//END AUTOGENERATED CODE: Template Overrides 'DelayedPsiExplosion'
...
static function X2AbilityTemplate AddPsiExplosionAbility()
{
	...
	Template.CinescriptCameraType = "Sectoid_PsiExplosion";
//BEGIN AUTOGENERATED CODE: Template Overrides 'PsiExplosion'
	Template.bFrameEvenWhenUnitIsHidden = true;
//END AUTOGENERATED CODE: Template Overrides 'PsiExplosion'
...
simulated function DelayedPsiExplosion_BuildVisualization(XComGameState VisualizeGameState)
{
	local XComGameStateHistory History;
	local XComGameStateContext_Ability Context;
	local StateObjectReference InteractingUnitRef;
...
simulated function PsiExplosion_BuildVisualization(XComGameState VisualizeGameState)
{
	local XComGameStateHistory History;
	local XComGameStateContext_Ability  Context;
	local StateObjectReference InteractingUnitRef;
