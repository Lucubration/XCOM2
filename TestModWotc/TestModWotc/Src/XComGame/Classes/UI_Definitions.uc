...
enum EAchievementType
{
	...
	// XPack - War of the Chosen Achievements
	AT_LostAndAbandoned,				// Complete the Lost and Abandoned Mission
	AT_DefeatChosen,					// Permanently defeat one of the Chosen
	AT_LostHeadshots,					// Get 15 headshots against Lost in a single turn
	AT_ReaperShadowKills,				// Get 4 kills from Shadow with a Reaper in a single mission
	AT_TemplarFocusCycle,				// Get a Templar to max Focus, spend it all, then get to max again
	AT_SkirmisherMultiActions,			// Take 3 offensive actions against the same target with a Skirmisher in one turn
	AT_MaxLevelBond,					// Form a level 3 bond
