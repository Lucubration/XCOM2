...
function bool ChallengeModeShutdown()
{
	...
	`ClearDelegatesArray(ClientStateChange);
...
function bool OpenUserEULAs() { return false; }

//---------------------------------------------------------------------------------------
//  Client States
//---------------------------------------------------------------------------------------
function bool IsTokenCached() { return false; }
function bool IsAccountLinked() { return false; }
function bool IsConnected() { return false; }
function bool IsLoggedIn() { return false; }
function bool IsBusy() { return false; }
function bool IsReady() { return false; }
function bool HasDeclinedUserEULAs() { return false; }
...
*/
function bool PerformChallengeModeGetDeactivatedIntervals(optional int NumberDaysPrior = 90) { return false; }
...
*/
function bool PerformChallengeModeGetTopGameScores(string ChallengeKeyname, optional int Offset = 0, optional int Limit = 10) { return false; }
function bool PerformChallengeModeGetGameScoresFriends(string ChallengeKeyname, const array<string> PlatformFriendIDs) { return false; }
