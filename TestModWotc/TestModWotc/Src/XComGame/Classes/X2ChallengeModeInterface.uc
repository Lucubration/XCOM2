...
//  Client States
//---------------------------------------------------------------------------------------
function bool IsTokenCached();
function bool IsAccountLinked();
...
`AddClearDelegatesPrototype(ClientStateChange);
 ...
 */
function bool PerformChallengeModeGetIntervals(optional bool bGetSeedData = true);
...
`AddClearDelegatesPrototype(ReceivedChallengeModeIntervalStart);

/**
* Called once all of the interval entries have been processed
*/
delegate OnReceivedChallengeModeIntervalEnd();
`AddClearDelegatesPrototype(ReceivedChallengeModeIntervalEnd);
...
`AddClearDelegatesPrototype(ReceivedChallengeModeIntervalEntry);
 ...
 */
function bool PerformChallengeModeGetDeactivatedIntervals(optional int NumberDaysPrior=90);
...
`AddClearDelegatesPrototype(ReceivedChallengeModeDeactivatedIntervalStart);
...
`AddClearDelegatesPrototype(ReceivedChallengeModeDeactivatedIntervalEnd);

/**
 * Called whenever a deactivated interval data is retrieved from the server
 */
...
`AddClearDelegatesPrototype(ReceivedChallengeModeDeactivatedIntervalEntry);
 ...
 */
 function bool PerformChallengeModeGetTopGameScores(string ChallengeKeyname, optional int Offset=0, optional int Limit=10);
 function bool PerformChallengeModeGetGameScoresFriends(string ChallengeKeyname, const array<string> PlatformFriendIDs);
