...
auto state PendingMatch
{
	...
	{
		class'X2TacticalGameRuleset'.static.ReleaseScriptLog( "XComTacticalGame::PendingMatch - Begin State" );
	...
	{
		class'X2TacticalGameRuleset'.static.ReleaseScriptLog( "XComTacticalGame::PendingMatch - End State ->"@NextStateName );
...
Begin:
	...
	//{
		...
		class'X2TacticalGameRuleset'.static.ReleaseScriptLog( "XComTacticalGame::PendingMatch - Wait on Async Loading" );
		while( WorldInfo.bRequestedBlockOnAsyncLoading )
		{
			Sleep( 0.1f );
		}
		class'X2TacticalGameRuleset'.static.ReleaseScriptLog( "XComTacticalGame::PendingMatch - Wait on Async Loading Complete" );

		if (class'WorldInfo'.static.IsPlayInEditor())
		{
			class'X2TacticalGameRuleset'.static.ReleaseScriptLog( "XComTacticalGame::PendingMatch - Map Manager Streaming Loading" );
			while (!`MAPS.IsStreamingComplete( ))
			{
				sleep( 0.0f );
			}
			class'X2TacticalGameRuleset'.static.ReleaseScriptLog( "XComTacticalGame::PendingMatch - Map Manager Streaming Loading Complete" );
		}
...
state Playing
{
	...
	{
		class'X2TacticalGameRuleset'.static.ReleaseScriptLog( "XComTacticalGame::Playing - Begin State" );
	...
	function EndState(name NextStateName)
	{
		class'X2TacticalGameRuleset'.static.ReleaseScriptLog( "XComTacticalGame::Playing - End State ->"@NextStateName );
		super.EndState( NextStateName );
	}
...
function StartMatch()
{
	class'X2TacticalGameRuleset'.static.ReleaseScriptLog("XComTacticalGame::StartMatch");
