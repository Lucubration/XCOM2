...
var const config(MissionDefs) array<MissionDefinition> arrMissions;
...
var const config array<ChosenSpawningTagToEncounterIDInformation> ChosenSpawnTagToEncounterID;
