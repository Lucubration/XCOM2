...
function ResetPlotValueCache()
{
	CachedMaxFloor = -1;
	CachedCursorFloorOffset = 0;

	class'X2TacticalGameRuleset'.static.ReleaseScriptLog( "XCom3DCursor::ResetPlotValueCache" );
}
...
simulated function MoveToUnit( XComUnitPawn Unit, optional bool bSetCamView=true, optional bool bResetChainedDistance=true )
{
	...
	if( bResetChainedDistance )
	{
		...
		if(`Pres.m_kTacticalHUD == none || `Pres.m_kTacticalHUD.m_kAbilityHUD.TargetingMethod == none)
		{
