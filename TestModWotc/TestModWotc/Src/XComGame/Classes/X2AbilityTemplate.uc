...
var editinlineuse protectedwrite array<X2Effect>	AbilityTargetEffects;           //  effects which apply to the main target only
var editinlineuse protectedwrite array<X2Effect>	AbilityMultiTargetEffects;      //  effects which apply to the multi targets only
var editinlineuse protectedwrite array<X2Effect>	AbilityShooterEffects;          //  effects which always apply to the shooter, regardless of targets
