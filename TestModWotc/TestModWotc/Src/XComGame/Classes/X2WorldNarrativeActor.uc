...
function CreateState(XComGameState StartGameState)
{
	...
	ObjectState = XComGameState_WorldNarrativeActor(StartGameState.CreateNewStateObject(class'XComGameState_WorldNarrativeActor'));
	...
	{
		StartGameState.CreateNewStateObject(class'XComGameState_WorldNarrativeTracker');
	}
