...
var() bool  ExcludeUnableToAct;		//	excluded if IsAbleToAct is false
...
var() bool	  RequireUnitSelectedFromHQ;  //  requires that the target must have been selected from Headquarters (XCOM-only)
