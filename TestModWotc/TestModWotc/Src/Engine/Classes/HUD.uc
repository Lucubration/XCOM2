...
event OnLostFocusPause(bool bEnable)
{
	...
	if ( WorldInfo.NetMode != NM_Client )
	{
		...
		PlayerOwner.SetPause(bEnable,,true);
	}
}

/**
 *	Notifies the hud when the main window's focus is lost or gained
 *	@param bHasFocus True if the window currently has focus
 */
