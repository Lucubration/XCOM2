...
simulated protected function OnEffectAdded(const out EffectAppliedData ApplyEffectParameters, XComGameState_BaseObject kNewTargetState, XComGameState NewGameState, XComGameState_Effect NewEffectState)
{
	...
	if (GetZoneOfControlComponent(NewEffectState) == none)
	{
		...
		EventMgr.RegisterForEvent(ListenerObj, 'AbilityActivated', class'XComGameState_Effect_ZoneOfControl'.static.OnAbilityActivated, ELD_OnStateSubmitted);
		//EventMgr.RegisterForEvent(ListenerObj, 'ObjectMoved', class'XComGameState_Effect_ZoneOfControl'.static.OnObjectMoved, ELD_OnStateSubmitted); // Deprecated
		//EventMgr.RegisterForEvent(ListenerObj, 'UnitMoveFinished', class'XComGameState_Effect_ZoneOfControl'.static.OnUnitMoveFinished, ELD_OnStateSubmitted); // Deprecated
		...
		EventMgr.RegisterForEvent(ListenerObj, 'TacticalGameEnd', class'XComGameState_Effect_ZoneOfControl'.static.OnTacticalGameEnd, ELD_OnStateSubmitted);
...
simulated function bool OnEffectTicked(const out EffectAppliedData ApplyEffectParameters, XComGameState_Effect kNewEffectState, XComGameState NewGameState, bool FirstApplication)
{
	...
	DefenseEffectParams.EffectRef.SourceTemplateName = class'X2Ability_InfantryAbilitySet'.default.ZoneOfControlCounterAttackDefenseAbilityName;
