class X2GlobalHooks extends X2AmbientNarrativeCriteria;
...
static function array<X2DataTemplate> CreateTemplates()
{
	...
	ApplyLightEmUpToAbility('CripplingShot');
	ApplyLightEmUpToAbility('StaggeringShot');
	//ApplyLightEmUpToAbility('FireForEffect');
...
static function ApplyLightEmUpToAbility(name abilityName)
{
	...
	{
		if (ActionPointCost.DoNotConsumeAllSoldierAbilities[i] == 'LightEmUp')
		{
			UpdatedAbility = true;
			break;
		}
