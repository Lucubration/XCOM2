...
simulated protected function OnEffectAdded(const out EffectAppliedData ApplyEffectParameters, XComGameState_BaseObject kNewTargetState, XComGameState NewGameState, XComGameState_Effect NewEffectState)
{
	...
	if (GetStickAndMoveComponent(NewEffectState) == none)
	{
		...
		EventMgr.RegisterForEvent(ListenerObj, 'UnitMoveFinished', class'XComGameState_Effect_StickAndMove'.static.OnUnitMoveFinished, ELD_OnStateSubmitted);
		...
		EventMgr.RegisterForEvent(ListenerObj, 'TacticalGameEnd', class'XComGameState_Effect_StickAndMove'.static.OnTacticalGameEnd, ELD_OnStateSubmitted);
