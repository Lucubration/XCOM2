...
static function X2DataTemplate HighExplosiveRocket()
{
	...
	Template.Tier = -2; // Rocket tiers are now negative to prevent them from being selected over frag/plasma grenades when making items available
...
static function X2DataTemplate HighExplosiveRocketMk2()
{
	...
	Template.DamageTypeTemplateName = 'Explosion';
	Template.Tier = -1; // Rocket tiers are now negative to prevent them from being selected over frag/plasma grenades when making items available
