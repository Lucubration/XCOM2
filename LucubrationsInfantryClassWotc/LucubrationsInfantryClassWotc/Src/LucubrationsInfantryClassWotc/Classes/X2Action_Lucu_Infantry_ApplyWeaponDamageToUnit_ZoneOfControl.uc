...
class X2Action_Lucu_Infantry_ApplyWeaponDamageToUnit_ZoneOfControl extends X2Action 
...
function Init()
{
	...
	local X2Action_Lucu_Infantry_ApplyWeaponDamageToUnit_ZoneOfControl OtherAction;
	...
	//`LOG("Lucubration Infantry Class: Zone of Control X2Action_Lucu_Infantry_ApplyWeaponDamageToUnit_ZoneOfControl initializing.");
	...
	if (AbilityContext != none || TickContext != none)
	{
		...
		{
			HasSiblingOfType(class'X2Action_Lucu_Infantry_ApplyWeaponDamageToUnit_ZoneOfControl', ApplyDamageToUnitActions);
			...
			{
				OtherAction = X2Action_Lucu_Infantry_ApplyWeaponDamageToUnit_ZoneOfControl(ApplyDamageToUnitActions[ActionIndex]);
