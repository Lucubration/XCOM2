class XComGameState_Lucu_Infantry_Effect_StickAndMove extends XComGameState_BaseObject
...
function EventListenerReturn OnAbilityActivated(Object EventData, Object EventSource, XComGameState GameState, Name EventID, Object CallbackData)
{
	...
	if (AbilityTemplate.Hostility == eHostility_Offensive)
	{
		...
		ApplyAbilityName = class'X2Ability_Lucu_Infantry_InfantryAbilitySet'.default.StickAndMoveMobilityAbilityName;
		ApplyEffectName = class'X2Ability_Lucu_Infantry_InfantryAbilitySet'.default.StickAndMoveMobilityEffectName;
		...
		if (IsAbilityPostActivation)
		{
				...
				SourceWeaponTemplate.InventorySlot == eInvSlot_SecondaryWeapon)
			{
				...
				RemoveEffectName = class'X2Ability_Lucu_Infantry_InfantryAbilitySet'.default.StickAndMoveDamageEffectName;
			}
		}
		else
		{
	...
	else if (AbilityContext.InputContext.MovementPaths.Length > 0)
	{
		...
		ApplyAbilityName = class'X2Ability_Lucu_Infantry_InfantryAbilitySet'.default.StickAndMoveDamageAbilityName;
		ApplyEffectName = class'X2Ability_Lucu_Infantry_InfantryAbilitySet'.default.StickAndMoveDamageEffectName;
	}
	else
	{
...
function EventListenerReturn OnUnitMoveFinished(Object EventData, Object EventSource, XComGameState GameState, Name EventID, Object CallbackData)
{
	...
	foreach UnitState.AffectedByEffects(CompareEffectRef)
	{
		...
		if (CompareEffectState.GetX2Effect().EffectName == class'X2Ability_Lucu_Infantry_InfantryAbilitySet'.default.StickAndMoveMobilityEffectName)
		{
