class X2Effect_Lucu_Infantry_DeepReserves extends X2Effect_Persistent;
...
simulated protected function OnEffectAdded(const out EffectAppliedData ApplyEffectParameters, XComGameState_BaseObject kNewTargetState, XComGameState NewGameState, XComGameState_Effect NewEffectState)
{
	...
	local XComGameState_Lucu_Infantry_Effect_DeepReserves DeepReservesEffectState;
	...
	if (GetDeepReservesComponent(NewEffectState) == none)
	{
		...
		DeepReservesEffectState = XComGameState_Lucu_Infantry_Effect_DeepReserves(NewGameState.CreateStateObject(class'XComGameState_Lucu_Infantry_Effect_DeepReserves'));
		...
		EventMgr.RegisterForEvent(ListenerObj, 'UnitTakeEffectDamage', class'XComGameState_Lucu_Infantry_Effect_DeepReserves'.static.OnUnitTakeEffectDamage, ELD_OnStateSubmitted, , TargetUnit);
		...
		EventMgr.RegisterForEvent(ListenerObj, 'TacticalGameEnd', class'XComGameState_Lucu_Infantry_Effect_DeepReserves'.static.OnTacticalGameEnd, ELD_OnStateSubmitted);
...
static function XComGameState_Lucu_Infantry_Effect_DeepReserves GetDeepReservesComponent(XComGameState_Effect Effect)
{
    if (Effect != none) 
        return XComGameState_Lucu_Infantry_Effect_DeepReserves(Effect.FindComponentObject(class'XComGameState_Lucu_Infantry_Effect_DeepReserves'));
    return none;
}
